...
losses_300 = np.load(os.path.join(os.path.dirname(__file__),'../results/traintest_lossexp17.npz'))
losses_500 = np.load(os.path.join(os.path.dirname(__file__),'../results/traintest_lossexp19.npz'))
losses_700 = np.load(os.path.join(os.path.dirname(__file__),'../results/traintest_lossexp18.npz'))
