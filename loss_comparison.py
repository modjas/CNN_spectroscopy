...
validation_loader = load_data.load_experiment_data('spectra_normalized.npz','validation')
...
model.load_state_dict(torch.load('results/model_exp41.pth', map_location='cpu'))
model.eval()
...
model.load_state_dict(torch.load('results/model_exp42.pth', map_location='cpu'))
model.eval()
...
model.load_state_dict(torch.load('results/model_exp39.pth', map_location='cpu'))
model.eval()
...
model.load_state_dict(torch.load('results/model_exp40.pth', map_location='cpu'))
model.eval()
